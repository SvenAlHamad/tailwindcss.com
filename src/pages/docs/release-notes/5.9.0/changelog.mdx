...
<img alt="Improved Scaffolding" src={scaffolds}/>
...
<img alt="AWS Lambda Function Build Error" src={webpackError}/>
...
<img alt="API and React Security Packages" src={securityPackages} style={{margin: "0 auto"}}/>
