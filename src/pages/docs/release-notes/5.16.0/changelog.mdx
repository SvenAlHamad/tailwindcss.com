...
<img src={exportPageUI} alt='Page Builder - export page demo' style={{width: "100%"}}/>
...
<img src={importPageUI} alt='Page Builder - export page demo' style={{maxwidth: "100%"}}/>
...
<img src={watchDeployPaneImprovement} alt='"webiny watch" Command - The Improved Deploy Pane' style={{maxwidth: "100%"}}/>
