...
<img src={accessManagement} alt='Access Management and Admin Users now have separate sections in the main navigation.'/>
...
<img src={eventsAutocomplete} alt='Discover application events by typing "on" to filter out event topics.'/>
...
<img src={tenantManager} alt="Tenant Manager module allows you to create new tenants and switch between them."/>
...
<img src={oktaLogin} alt="Okta login using Okta's React SDK."/>
...
<img src={revisionsMenu} alt="Menu now changes direction depending on its location in the view."/>
...
<img src={gridWidth} alt="gridWidth"/>
