...
<img src={webinyDynamoDb} alt={"The highlight of this release - the new Amazon DynamoDB-only version of Webiny!"} />
...
<img src={pulumiCliJsonIssue} alt="Inappropriate output of the 'webiny pulumi' command." />
