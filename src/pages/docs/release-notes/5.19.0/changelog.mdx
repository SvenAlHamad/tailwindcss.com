...
<img src={truncationFixed} alt="The highlight of this release - the new Amazon DynamoDB-only version of Webiny!" />
...
<img src={pageBuilderBtnAction} alt="The highlight of this release - the new Amazon DynamoDB-only version of Webiny!" />
