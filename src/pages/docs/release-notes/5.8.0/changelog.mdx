...
<img alt={`Filtering of Content Entries by "createdBy" Field`} src={createdBy}/>
...
<img alt={`Filtering of Content Entries by "id" Field`} src={retrieveById}/>
...
<img alt={`Filtering of Content Entries by "entryId"`} src={entryId}/>
