...
import themeManager from "../../enterprise/theme-manager/tenant-themes.png";
import oktaLogin from "../../enterprise/okta-integration/okta-login.png";
...
<img src={singlePreValue} alt="Predefined single value" />



How it looks when creating an entry:

<img src={selSinglePreValue}   style={{ margin: "0 auto" }}
...
<img src={multiplePreValue} alt="Predefined multiple values" />


How it looks when creating the entry:

<img src={selMultiplePreValue} 
  style={{ margin: "0 auto" }}
 alt="Predefined single selected value" />
...
<img src={themeManager} alt="Assign Themes to Tenants" />
...
<img src={oktaLogin} alt="Okta Login" />
