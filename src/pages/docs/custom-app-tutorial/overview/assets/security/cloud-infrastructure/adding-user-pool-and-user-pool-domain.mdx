...
```ts pinterest-clone/api/pulumi/dev/cognito.ts {14,42}
...
```ts pinterest-clone/api/pulumi/dev/index.ts {5,17,53-56}
...
![Automatic Re-deployment of Cloud Infrastructure](./adding-user-pool-and-user-pool-domain/cloud-infra-auto-deploy.png)
...
![Automatic Re-deployment of Cloud Infrastructure](./adding-user-pool-and-user-pool-domain/cloud-infra-deploy.png)
