...
```ts pinterest-clone/app/code/webiny.config.ts {16-18,21-23,40-47,67-74}
...
![Running webiny Output Command on a Non-existing and Existing Environments](./adjusting-webiny-config-ts/stack-output-example.png)
