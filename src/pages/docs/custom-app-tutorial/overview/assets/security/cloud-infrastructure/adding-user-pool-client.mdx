...
```ts pinterest-clone/app/pulumi/cognito.ts {22}
...
```ts pinterest-clone/app/pulumi/index.ts {13,24,28-30}
...
![Initial deployment of Cloud Infrastructure](./adding-user-pool-client/cloud-infra-deploy.png)
