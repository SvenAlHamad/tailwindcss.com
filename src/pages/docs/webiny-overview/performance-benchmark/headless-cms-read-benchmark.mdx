...
![image](./assets/hc-read-api/summary.svg)
...
![Headless CMS benchmark - Response time](./assets/hc-read-api/response-time-d.png)
...
![Headless CMS benchmark - Response time](./assets/hc-read-api/response-time-e.png)

### Throughput

#### Test D

![Headless CMS benchmark - Throughput](./assets/hc-read-api/throughput-d.png)

#### Test E

![Headless CMS benchmark - Throughput](./assets/hc-read-api/throughput-e.png)
...
![image](./assets/hc-read-api/cost-per-request.svg)
