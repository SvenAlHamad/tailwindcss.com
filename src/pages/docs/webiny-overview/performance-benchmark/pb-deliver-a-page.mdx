...
![Page Builder benchmark - Response time](./assets/pb-deliver-a-page/response-time.png)
...
![Page Builder benchmark - Throughput](./assets/pb-deliver-a-page/throughput.png)
