...
![image](./assets/hc-write-api/summary.svg)
...
![Headless CMS benchmark - Response time](./assets/hc-write-api/response-time-d.png)
...
![Headless CMS benchmark - Response time](./assets/hc-write-api/response-time-e.png)

### Throughput

#### Test D

![Headless CMS benchmark - Throughput](./assets/hc-write-api/throughput-d.png)

#### Test E

![Headless CMS benchmark - Throughput](./assets/hc-write-api/throughput-e.png)
...
![image](./assets/hc-write-api/cost-per-request.svg)
