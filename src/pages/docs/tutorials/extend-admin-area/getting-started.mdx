...
<img alt="Scaffolds List" style={{ maxWidth: 650, width: '100%' }} src={scaffoldsList}/>
...
<img alt="Extend Admin Area - Full Output" src={scaffoldsFullOutput}/>
...
<img alt="Watching Our Application Code" src={watchSessions}/>
...
<img shadow={false} alt="New Car Manufacturers Module" src={scaffoldsAdminArea}/>
