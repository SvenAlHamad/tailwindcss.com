...
<img alt="Main Menu - Car Manufacturers Module" src={carManufacturersMenuItem} />
...
<img alt="Cannot Access Route - Not Authorized Message" src={routeNotAuthorized} />
...
<img alt='Hiding the "New Car Manufacturer Button"' src={hidingNewButton} />
