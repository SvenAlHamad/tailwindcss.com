...
![Main Menu - Car Manufacturers Module](./assets/car-manufacturers-menu-item.png)
...
![Main Menu - Car Manufacturers Module (Hidden)](./assets/car-manufacturers-menu-item-hidden.png)
...
![Cannot Access Route - Not Authorized Message](./assets/route-not-authorized.png)
...
![Hiding the New Car Manufacturer Button](./assets/hiding-new-button.png)
...
![Hiding the New Car Manufacturer Button](./assets/hiding-new-button-hidden.png)
...
![Hiding the Car Manufacturers Data List - Delete Button (Hidden)](./assets/delete-button-in-datalist.png)
