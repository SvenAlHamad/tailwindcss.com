...
<img alt="Security Groups Module" src={securityGroupsModule} />

By default, we get to specify permissions for every installed Webiny application:

<img alt="Only a Single Security Group Allowed" src={securityGroupsPermissions} />
...
<img alt="Added Security Permissions Group" src={addedSecurityPermissionsGroup} />
...
```ts packages/car-manufacturers/admin-app/src/index.ts
...
<img alt="New Car Manufacturers Security Group" src={newSecurityGroup} />
...
<img alt="Define Access on a Locale Level" src={contentLocaleSection} />
