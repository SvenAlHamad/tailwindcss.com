...
![Added Security Permissions Group](./assets/added-security-permissions-group.png)
...
![New Car Manufacturers Security Group](./assets/new-security-group.png)
...
![Define Access on a Locale Level](./assets/content-locale-section.png)
