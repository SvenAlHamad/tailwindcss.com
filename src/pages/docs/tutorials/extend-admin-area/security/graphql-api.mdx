...
![Exposed GraphQL Queries](./assets/unprotected-query.png)

Even more important, anybody can create new car manufacturers, with the `createCarManufacturer` GraphQL mutation:

![Exposed GraphQL Mutations](./assets/unprotected-mutation.png)
...
![GraphQL Authorization Error](./assets/query-auth-error.png)
...
![Create a Test User](./assets/create-test-user.png)
...
![GraphQL Authorization Success](./assets/query-auth-success.png)
