...
<img alt="Exposed GraphQL Queries" src={unprotectedQuery} />

Even more important, anybody can create new car manufacturers, with the `createCarManufacturer` GraphQL mutation:

<img alt="Exposed GraphQL Mutations" src={unprotectedMutation} />
...
<img alt="GraphQL Authorization Error" src={graphqlAuthError} />
...
<img alt="Create a Test User" src={createTestUser} />
...
<img alt="GraphQL Authorization Success" src={graphqlAuthSuccess} />
