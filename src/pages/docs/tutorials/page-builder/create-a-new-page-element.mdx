...
```json {project-root}/package.json {7}
(...)
"workspaces": {
  "packages": [
    "apps/admin/code",
...
```ts apps/admin/code/src/plugins/pageBuilder/editorPlugins.ts {4,7-8}
(...)
...
```ts apps/admin/code/src/plugins/pageBuilder/renderPlugins.ts {4,8}
(...)
...
```ts apps/website/code/src/plugins/pageBuilder.ts {5,10}
...
![Page preview inside editor](../assets/page-builder/iframe-website.png)
