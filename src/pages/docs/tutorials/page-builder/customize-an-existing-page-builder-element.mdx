...
![default button element settings in editor sidebar](../assets/page-builder/default-button-settings.png)
...
![updated button element settings in editor sidebar](../assets/page-builder/updated-button-settings.png)
...
![updated button element settings in editor sidebar](../assets/page-builder/no-change-button-settings.gif)
...
![change button element settings in editor sidebar](../assets/page-builder/change-button-settings.gif)
...
![default settings for a new button in editor](../assets/page-builder/default-settings-for-a-new-button.gif)
...
```ts {13-32} apps/admin/code/src/plugins/pageBuilder/editorPlugins.ts
...
![with default settings value for a new button in editor](../assets/page-builder/width-default-settings-value-for-button.gif)
