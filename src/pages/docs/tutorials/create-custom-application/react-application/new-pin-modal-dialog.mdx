...
![Open New Pin Modal Dialog](./new-pin-modal-dialog/plus-header-button.png)
...
```tsx pinterest-clone/app/code/src/components/Layout.tsx {1,2,3,6,13,24-32,38}
...
![New Pin Modal Dialog](./new-pin-modal-dialog/new-pin-modal-dialog.png)
