...
<img shadow={false} style={{maxWidth: 650}} alt="Application Layout" src={applicationLayout} />
...
<img style={{maxWidth: 650 }} alt="Application Layout - Blank Homepage" src={endResult} />
