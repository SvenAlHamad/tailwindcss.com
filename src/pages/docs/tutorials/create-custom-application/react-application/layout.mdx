...
```tsx pinterest-clone/app/code/src/App.tsx {9}
...
<img shadow={false} style={{maxWidth: 650, width: '100%'}} alt="Application Layout" src={applicationLayout} />
...
<img style={{maxWidth: 650, width: '100%' }} alt="Application Layout - Blank Homepage" src={endResult} />
