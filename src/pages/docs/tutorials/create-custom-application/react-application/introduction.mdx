...
![The Pinterest Clone Application](./introduction/view-pins.png)

2. **Pin Details**:
![Viewing a Pin](./introduction/view-pin.png)

With these two pages, we'll also have to create a simple **New Pin** modal dialog that will enable users to create new pins:

![New Pin Modal Dialog](./introduction/new-pin-modal-dialog.png)
