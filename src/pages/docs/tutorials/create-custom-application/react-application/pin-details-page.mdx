...
```tsx pinterest-clone/app/code/src/plugins/routes/pinDetails.tsx {3}
// We register routes via the `RoutePlugin` plugin.
export default new RoutePlugin({
    route: <Route path="/pins/:id" exact component={PinDetails} />
});
...
```scss pinterest-clone/app/code/src/App.scss {4}
...
![Pin Details Page](./pin-details-page/pin-details-page.png)
