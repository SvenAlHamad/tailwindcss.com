...
![Pinterest - The Mosaic Layout](./homepage/pinterest-mosaic-layout.png)
...
```ts pinterest-clone/app/code/src/plugins/index.ts {3,12}
...
![Homepage - List of Pins](./homepage/homepage.png)
