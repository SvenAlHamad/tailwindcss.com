...
<img alt="Extend GraphQL API Scaffold - Full Output" src={extendGqlApiScaffoldOutput} />
...
<img alt={'"CreatePin Mutation" Test'} src={createPinMutation} />
...
<img alt={'"CreatePin Mutation" Test'} src={coverImagePreview} />
