...
```
![Extend GraphQL API Scaffold](./graphql-api/extend-gql-api-scaffold.png)
...
![Extend GraphQL API Scaffold - Full Output](./graphql-api/extend-gql-api-scaffold-output.png)
...
![CreatePin Mutation Test](./graphql-api/create-pin-mutation-test.png)
...
```diff-js ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/entities/Pin.ts
...
```ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/types.ts {7}
...
```ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/typeDefs.ts {6,14,20}
...
![CreatePin Mutation Test](./graphql-api/cover-image-preview.png)
