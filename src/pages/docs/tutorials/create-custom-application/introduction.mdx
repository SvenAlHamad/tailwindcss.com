...
![The Pinterest Clone Application - Pins List](./introduction/view-pins.png)

![The Pinterest Clone Application - Pin Details](./introduction/view-pin.png)
...
![Create Custom Application - The Plan](./introduction/plan.png)
