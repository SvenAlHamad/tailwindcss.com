...
![Header Bar - Not Logged In State](./integrating-hosted-ui-authentication-flow/header-not-logged-in.png)
...
![Header Bar - Logged In State](./integrating-hosted-ui-authentication-flow/header-logged-in.png)
...
```tsx pinterest-clone/app/code/src/components/Layout.tsx {5-6,16-18,30-57}
...
![Hosted UI Authentication Flow - Sign In](./integrating-hosted-ui-authentication-flow/hosted-ui-01-sign-in.png)

Since this is our first visit, we can click on the **Sign up** link below, which will then take us to the **Sign Up** form:

![Hosted UI Authentication Flow - Sign Up](./integrating-hosted-ui-authentication-flow/hosted-ui-02-sign-up.png)
...
![Hosted UI Authentication Flow - E-mail Verification](./integrating-hosted-ui-authentication-flow/hosted-ui-03-verification.png)
...
![Header Bar - Logged In State](./integrating-hosted-ui-authentication-flow/header-logged-in-without-menu.png)
