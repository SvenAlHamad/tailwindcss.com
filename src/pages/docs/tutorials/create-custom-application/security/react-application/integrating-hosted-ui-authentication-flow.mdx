...
<img alt="Header Bar - Not Logged In State" src={headerNotLoggedIn} />
...
<img alt="Header Bar - Logged In State" src={headerLoggedIn} />
...
<img alt="Header Bar - Logged In State" src={headerLoggedInWithoutMenu} />
