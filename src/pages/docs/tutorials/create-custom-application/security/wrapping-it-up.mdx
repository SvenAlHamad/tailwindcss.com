...
![Current Profile Details Page](./wrapping-it-up/pin-details-current.png)
...
```tsx pinterest-clone/app/code/src/plugins/routes/pinDetails.tsx {19-21,51-54}
...
![Updated Profile Details Page](./wrapping-it-up/pin-details-final.png)
