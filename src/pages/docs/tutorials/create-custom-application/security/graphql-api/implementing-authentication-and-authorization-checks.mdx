...
![CreatePin Mutation - Publicly Accessible](./implementing-authentication-and-authorization-checks/create-pin-mutation-test.png)
...
![GraphQL Playground - Setting authorization Header](./implementing-authentication-and-authorization-checks/graphql-client-authorization-header.png)
...
![Google Chrome - Network Tab](./implementing-authentication-and-authorization-checks/network-tab-authorization-token.png)
...
```ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/resolvers/PinsMutation.ts {7-11,24-28}
/**
...
![CreatePin Mutation - Not Authorized](./implementing-authentication-and-authorization-checks/create-pin-mutation-unauthorized.png)
...
![CreatePin Mutation - Authorized](./implementing-authentication-and-authorization-checks/create-pin-mutation-authorized.png)
...
```ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/resolvers/PinsMutation.ts {8-12,20-22}
/**
...
![UpdatePin Mutation - Not Authorized](./implementing-authentication-and-authorization-checks/update-pin-cannot-update-other-users-pin.png)
...
![CreatePin Mutation - Authorized](./implementing-authentication-and-authorization-checks/update-pin-update-with-user.png)
 -->
...
![UpdatePin Mutation - Authorized](./implementing-authentication-and-authorization-checks/update-pin-update-with-user.png)
...
```ts pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/resolvers/PinsMutation.ts {7-11,19-21}
/**
...
![DeletePin Mutation - Authorized](./implementing-authentication-and-authorization-checks/delete-pin-authorized.png)
