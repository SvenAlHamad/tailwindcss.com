...
<Alert type="success">tip What you'll learn
...
```tsx apps/admin/code/src/plugins/headlessCMS/fields/secretText/secretTextFieldPlugin.tsx
...
```ts apps/admin/code/src/plugins/headlessCms.ts {5,13}
(...)
...
<img src={fieldDefinition} alt="Field Definition" />
...
```tsx apps/admin/code/src/plugins/headlessCMS/fields/secretText/secretTextFieldRendererPlugin.tsx
import React from 'react'
...
```ts apps/admin/code/src/plugins/headlessCms.ts {5,14}
(...)
import richTextEditor from "./headlessCMS/richTextEditor";
...
4. As the [`webiny watch`](/docs/how-to-guides/use-watch-command) command is already running on `apps/admin`, we should see these changes immediately.
   ...
   <img src={fieldRendered} alt="Field Rendered" />
...
```ts api/code/headlessCMS/src/index.ts {5,12}
(...)
...
```ts api/code/headlessCMS/src/index.ts {5,13}
(...)
import scaffoldsPlugins from "./plugins/scaffolds";
...
<img src={encryptedText} alt="Encrypted Text" />
