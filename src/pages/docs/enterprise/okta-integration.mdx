...
![Okta SignIn Widget](./okta-integration/okta-login.png)
...
```ts api/code/graphql/src/security.ts
...
![Assign App Client ID to Tenant](./okta-integration/app-client-id-input.png)
