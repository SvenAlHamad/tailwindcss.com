...
![Assign Themes to an Individual Tenant](./theme-manager/tenant-themes.png)
...
![Enable Theme Manager Plugin in the GraphQL API.](./theme-manager/import-theme-manager-api.png)
...
```tsx apps/website/code/src/App.tsx
import React from "react";
...
![Add the New Workspace to the Project.](./theme-manager/workspaces.png)
...
![Activate a Specific Theme](./theme-manager/tenant-pb-settings.png)
