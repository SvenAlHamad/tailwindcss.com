...
![Enable Tenant Manager plugin.](./multi-tenancy/import-tenant-manager-api.png)
...
![Open Root Tenant Settings Dialog.](./multi-tenancy/root-tenant-settings.png)

![Configure Root Tenant Custom Domains.](./multi-tenancy/tenant-settings-dialog.png)
...
![Domain Settings For Sub-Tenants.](./multi-tenancy/new-tenant.png)
...
![Error Deleting Lambda@Edge Function.](./multi-tenancy/lambda-delete-error.png)
