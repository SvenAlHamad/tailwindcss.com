...
If you've run the two [`webiny watch`](/docs/how-to-guides/use-watch-command/) commands, mentioned in the [previous section](./get-started#using-the-watch-command), the performed application code changes should be automatically rebuilt and redeployed into the cloud.
