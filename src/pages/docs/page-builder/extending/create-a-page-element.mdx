...
![Iframe page element](./assets/iframe-end.png)
...
```diff-js json {project-root}/package.json
(...)
"workspaces": {
  "packages": [
    "apps/admin/code",
...
![Iframe page element](./assets/iframe-add-element.png)
...
![Iframe page element settings](./assets/drop-iframe-element.gif)
...
![Page preview inside editor](./assets/preview.png)
...
```diff-js ts apps/admin/code/src/plugins/pageBuilder/editorPlugins.ts
(...)
...
```diff-js ts apps/admin/code/src/plugins/pageBuilder/renderPlugins.ts
(...)
...
![Editor Iframe page element](./assets/iframe-element.gif)
...
```diff-js ts apps/website/code/src/plugins/pageBuilder.ts
...
![Page preview inside editor](./assets/iframe-website.png)
