...
![Default form layout](../../assets/headless-cms/create-a-content-model-form-layout/defaultLayout.png)

Once we import the plugin and register it in our `admin` app, we get our custom layout:

![Custom form layout](../../assets/headless-cms/create-a-content-model-form-layout/customLayout.png)
...
```tsx {3,8,13,18-27} pizzaLayout.tsx
import React from 'react'
import { CmsContentFormRendererPlugin } from '@webiny/app-headless-cms/types'
...
![Custom UI elements](../../assets/headless-cms/create-a-content-model-form-layout/customElements.png)
