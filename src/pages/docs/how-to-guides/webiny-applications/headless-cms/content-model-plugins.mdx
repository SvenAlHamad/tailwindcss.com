...
<img alt="Product and E-Commerce Items in the Admin Area Main Menu" src={basicsPluginsWork} />
...
<img alt="Content Model Groups Form - Icon Selector" src={faqIconSelector} />
