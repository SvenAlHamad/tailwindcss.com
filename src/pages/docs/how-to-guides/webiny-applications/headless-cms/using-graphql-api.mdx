...
![Access API Playground via Main Menu](./using-graphql-api/api_playground_from_main_menu.png)
...
![Switch Locale via the Locale Selector](./using-graphql-api/api-playground-switch-locale.png)
...
![Security - API Keys](./using-graphql-api/security-api-keys.png)
...
![Fine-grained Access Controls](./using-graphql-api/security-api-keys-form-1.png)

![Fine-grained Access Controls](./using-graphql-api/security-api-keys-form-2.png)

Once the API token has been created, you should see it in the user interface, for example:

![Copy the API Token](./using-graphql-api/api-token-value.png)
