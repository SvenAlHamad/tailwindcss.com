...
<img alt="Security - API Keys" src={securityApiKeys} />
...
<img alt="Fine-grained Access Controls" src={securityApiKeysFormPart1} />
<img alt="Fine-grained Access Controls" src={securityApiKeysFormPart2} style={{ marginTop: -25 }} />
