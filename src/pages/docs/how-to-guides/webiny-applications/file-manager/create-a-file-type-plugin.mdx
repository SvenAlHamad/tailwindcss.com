...
![Default File Type Plugins](./create-a-file-type-plugin/default-plugins.png)
...
![Custom video/mp4 Renderer](./create-a-file-type-plugin/mp4-plugin.png)
...
![Default File Actions](./create-a-file-type-plugin/file-actions.png)
...
![Custom File Action](./create-a-file-type-plugin/custom-actions.png)
