...
<img src={defaultPlugins} alt="Default File Type Plugins" />
...
<img src={mp4Plugin} alt={`Custom "video/mp4" Renderer`} />
...
<img src={fileActions} alt={`Default File Actions`} />
...
<img src={customActions} alt={`Custom File Action`} />
