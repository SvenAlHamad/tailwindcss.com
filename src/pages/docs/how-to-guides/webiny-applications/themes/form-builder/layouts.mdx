...
![Webiny form settings button](./images/webiny-fb-form-settings-button.png)

You should then see the following screen, and the "Layout" field at the bottom of the general settings form:

![Webiny form settings button](./images/webiny-fb-form-settings.png)
...
```ts {2,14-22} apps/theme/formBuilder/index.ts
import DefaultFormLayout from './layouts/DefaultFormLayout'
...
![Webiny form builder preview](./images/webiny-theme-form-layout.gif)
