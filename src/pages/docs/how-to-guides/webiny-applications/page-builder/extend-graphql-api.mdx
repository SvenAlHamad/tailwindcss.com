...
![Marking an Existing Page as Special](./extend-graphql-api/special-run-mutation.png)
...
![Querying Pages with the New Special Field Included in the Results](./extend-graphql-api/special-query-results.png)
...
```ts api/code/graphql/src/plugins/pages.ts {34-40,48-72}
import { GraphQLSchemaPlugin } from '@webiny/handler-graphql/plugins'
import { IndexPageDataPlugin } from '@webiny/api-page-builder/plugins/IndexPageDataPlugin'
import { Page } from '@webiny/api-page-builder/types'
...
![Listing Special Pages](./extend-graphql-api/list-pages-query.png)
...
![Duplicating an Existing Page](./extend-graphql-api/duplicates-run-mutation.png)

After the mutation has been executed, we should be able to see the created copy in the list of pages:

![Listing Pages After A Copy Has Been Created](./extend-graphql-api/duplicates-list-pages.png)
