...
![Page Settings View](./extend-page-settings/settingsView.png)
...
![New Password Field in the Schema](./extend-page-settings/schema.png)
...
![Password Field Added to the General Settings View](./extend-page-settings/passwordField.png)
...
![Password Is Now Returned from the API](./extend-page-settings/websitePassword.png)
...
![Password Field in the listPublishedPages Query](./extend-page-settings/listPublishedPages.png)
