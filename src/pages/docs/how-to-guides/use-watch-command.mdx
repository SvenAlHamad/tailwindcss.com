...
![Watch Command - Build, Deploy and Logs Panes](./use-watch-command/watch-command-preview.png)
...
![Enable Support For Pseudo Consoles](./use-watch-command/git-support-pseudo-consoles.png)
