...
<img shadow={false} style={{ maxWidth: 850 , width: '100%'}} alt="storing the data flow" src={storingTheData} />
...
<img shadow={false} style={{ maxWidth: 850, width: '100%' }} alt="fetching the data flow" src={fetchingTheData} />
