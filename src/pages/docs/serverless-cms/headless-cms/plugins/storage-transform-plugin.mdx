...
<img shadow={false} style={{ maxWidth: 850 }} alt="storing the data flow" src={storingTheData} />
...
<img shadow={false} style={{ maxWidth: 850 }} alt="fetching the data flow" src={fetchingTheData} />
