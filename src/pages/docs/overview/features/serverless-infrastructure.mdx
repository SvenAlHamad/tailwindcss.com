...
description: Webiny CMS - A content management system built on top of the AWS serverless cloud.
---
...
![Webiny - Serverless vs Traditional infrastructure](./assets/webiny-serverless-infrastructure.png)
