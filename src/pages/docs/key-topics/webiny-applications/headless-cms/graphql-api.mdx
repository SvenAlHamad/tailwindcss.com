...
![Access API Playground via Main Menu](./graphql-api/api_playground_from_main_menu.png)
...
API](/docs/how-to-guides/webiny-applications/headless-cms/using-graphql-api) guide.
...
Structure](/docs/key-topics/webiny-applications/headless-cms/graphql-api#the-graphql-api-url-structure)
...
![Fine-grained Access Controls](./graphql-api/security-cms-form-1.png)

![Fine-grained Access Controls](./graphql-api/security-cms-form-2.png)
...
check out the [Cloud Infrastructure - API](/docs/key-topics/cloud-infrastructure/api/introduction)
key topic. You can also skip to the [API
Overview](/docs/key-topics/cloud-infrastructure/api/overview#6-headless-cms) section, to
...
![Switch Locale via the Locale Selector](./graphql-api/api-playground-switch-locale.png)
...
![Find Headless CMS GraphQL API URLs via Webiny CLI](./graphql-api/api-url-webiny-cli.png)
...
![Webiny I18N Application - Locales Section](./graphql-api/i18n-locales-section.png)
