...
<img alt="Fine-grained Access Controls" src={securityImagePart1} />
<img alt="Fine-grained Access Controls" src={securityImagePart2} style={{ marginTop: -25 }} />
...
<img alt="API Playground" src={apiPlayground} />
...
<img alt="Switch Locale via the Locale Selector" src={apiPlaygroundSwitchLocale} />
...
<img alt="Find Headless CMS GraphQL API URLs via Webiny CLI" src={apiUrlWebinyCli} />
